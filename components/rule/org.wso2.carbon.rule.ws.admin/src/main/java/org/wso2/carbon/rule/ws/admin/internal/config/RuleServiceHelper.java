...
public class RuleServiceHelper {
    ...
    public static RuleService getRuleService(OMElement ruleServiceElement){
        RuleService ruleService = new RuleService(ruleServiceElement);
        ruleService.setName(HelperUtil.getAttributeValue(ruleServiceElement, Constants.RULE_CONF_ATTR_NAME));
        return ruleService;
    }
}
