...
public class TestJSR94BackendRuntimeFactory extends TestCase {

    public void testOrderProcessor() {
        JSR94BackendRuntimeFactory jsr94BackendRuntimeFactory = new JSR94BackendRuntimeFactory();

        Map<String, String> properties = new HashMap<String, String>();

        properties.put("class", "org.drools.jsr94.rules.RuleServiceProviderImpl");
        properties.put("uri", "http://drools.org/");
        properties.put("default.properties.provider", "org.wso2.carbon.rule.backend.jsr94.drools.DroolsJSR94DefaultPropertiesProvider");

        try {
            RuleBackendRuntime ruleBackendRuntime =
                    jsr94BackendRuntimeFactory.getRuleBackendRuntime(properties, this.getClass().getClassLoader());
